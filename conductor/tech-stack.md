...
- **Mapsui:** A high-performance mapping library for .NET MAUI, used for 2D map visualization.
- **MBTiles:** A specification for storing arbitrary tiled map data in SQLite databases, utilized for offline map support.
